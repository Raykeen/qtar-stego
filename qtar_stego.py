...
def find_adaptive_regions(tree):
    image = tree.root_node.image
    regions = tree.leaves
    #for region in regions:


rect = [0, 0, 512, 512]
prepared_image = prepare_image(img, 512)
root_node = ImageQTNode(None, rect, prepared_image['r'], 120, 2, 512)
